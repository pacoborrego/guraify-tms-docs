...
- **Parada activa del Tramo**: cada Tramo determina cuál de sus Paradas es la "que toca
  ...
  - Tramo de **recogida**, **recogida a domicilio** o **paso por hub**: su Parada de carga.
  - Tramo **directo**: la Parada de **carga** mientras siga abierta (borrador, en proceso,
    procesada, cargada o en ruta) y, en cuanto esta se cierra, **salta** a la Parada de
    **descarga**.

- **Tramo activo de la Orden**: la Orden elige como activo el Tramo marcado como tal. Si no
  hay ninguno marcado pero sólo existe un Tramo no domiciliario, ese se toma como activo;
  si no hay un candidato claro, la Orden se queda sin tramo activo.

- **Parada activa y Viaje activo de la Orden**: derivan del tramo activo. La parada activa
  de la Orden es la parada activa de ese tramo, y el Viaje activo es el Viaje de esa parada.
...
tramo. No es que los datos "desaparezcan": siguen en cada Tramo, pero la Orden sólo
...
.. note::
   ...
   (:doc:`/17.0/5_operational-flows/5_8_kpi-indicators`) se construyen a partir de la
   parada activa.
