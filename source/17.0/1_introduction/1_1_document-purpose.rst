...
organización funcional y sus entidades (capítulo 3), la parametrización (capítulo 4) y los
flujos operativos completos, de la Orden a la liquidación (capítulo 5). Está escrito para quien
va a poner el sistema en marcha en una empresa de transporte o va a adaptarlo a una operativa
nueva, y para el cliente que quiere entender lo que hay detrás de las pantallas.
