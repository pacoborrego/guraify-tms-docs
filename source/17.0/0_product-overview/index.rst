...
cualquiera que necesite explicárselo a otro. No hace falta conocer Odoo para leerlas.

Si busca cómo se configura o cómo funciona por dentro, eso está en el
:doc:`Manual de implantación </17.0/1_introduction/index>`. Si va a conectar otro sistema, en
la :doc:`Guía del integrador </17.0/7_edi-integrations/index>`. Y el vocabulario que se usa en
toda la documentación está en el :doc:`glosario </17.0/glossary>`.

.. toctree::
   :maxdepth: 1

   0_1_what-is-guraify-tms
   0_2_who-is-it-for
   0_3_how-it-works
   0_4_what-it-includes
   0_5_driver-app
   0_6_integrations
   0_7_use-cases
   0_8_faq
