...
Modelo Odoo: ``tms.pricelist.zone``. La agrupación de Áreas geográficas a efectos de precio. Una
Tarifa se apoya en una zona.
...
.. list-table::
   ...
   * - Áreas
     ...
     - Las áreas de tipo Zona Tarifa que componen la zona. Los detalles de las Líneas de tarifa
       fijan precios entre estas áreas.
   * - Agencia
