...
Modelo Odoo: ``tms.time.zone``. Una franja de servicio reutilizable, de una hora de inicio a una de
fin.
...
.. list-table::
   ...
   * - Franja horaria
     - Texto (calculado)
     - El nombre se compone solo con el formato HH:MM - HH:MM.
   * - Inicio / Fin
     - Hora
     - Hora de inicio y de fin de la franja. Obligatorias.
   * - Servicio
