...
Modelo Odoo: ``tms.transport.plan``. La red territorial: el conjunto de Áreas geográficas por las
que circula una operativa y la Agencia responsable.
...
.. list-table::
   ...
   * - Agencia
     ...
     - La Agencia responsable de la red. Se propaga a los Tramos cuya dirección cae en un área del
       plan.
   * - Áreas
