...
Modelo Odoo: ``tms.temperature``. Qué mercancía se transporta: seco, refrigerado, congelado, frágil. El modelo se llama «temperature» porque nació para las clases de temperatura y se generalizó.
...
.. list-table::
   ...
   * - Mín. (°C) / Máx. (°C)
     - Número
     - Límites de la clase de temperatura. Una lectura fuera de ellos es una excursión. Con los dos a cero no hay rango y no se juzga ninguna lectura.
   * - Tiene rango
     - Sí/No (calculado)
