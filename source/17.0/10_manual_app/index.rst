...
.. list-table::
   ...
   * - Palabra
     - Qué significa
   * - **Ruta**
     - Tu trabajo del día: la lista ordenada de paradas que tienes que hacer con tu vehículo.
   * - **Parada**
   ...
   * - **Con Reservas**
     - Has hecho la parada, pero no exactamente como estaba previsto: falta un bulto, uno viene
       dañado, lo has dejado al vecino. Siempre lleva un motivo, y a veces una foto.
   * - **Dominio**
     - El nombre de tu empresa en el sistema, que te dan en la oficina para entrar en la app.
