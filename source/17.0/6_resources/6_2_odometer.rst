...
.. admonition:: Ruta en Odoo
   ...
   Pestaña de odómetro de la ficha del vehículo («Odometer (TMS)», en TMS › Maestros › Equipos ›
   Vehículos) y Gestión de Recursos › Configuración › «Odometer Anomalies».
...
.. CAPTURA: 6_2_01 — descomentar el figure cuando esté la imagen
   .. figure:: /_static/img/6_resources/6_2_odometer_01_pestana-vehiculo.png
      :alt: Pestaña de odómetro de un vehículo
...
Válida, Borrador (pendiente de revisar) o Rechazada. Solo las lecturas válidas cuentan para el
...
crea el propio Odoo (por ejemplo, al anotar un servicio en la Flota) pasan por la detección y
nacen con su origen.
...
La pantalla de anomalías de odómetro lista las lecturas en borrador agrupadas por vehículo, con
...
telemetría si lo hay. Estos datos se actualizan en el momento en que entra o se valida una
lectura.
...
de km por día. La estimación viene con una confianza: **alta** solo cuando hay una lectura
válida exactamente en esa fecha; **media** cuando el valor se ha interpolado o extrapolado. Es
lo que usa el motor de preventivo cuando una orden de trabajo antigua no trae el kilometraje
real (ver :doc:`6_4_preventive-rules`). Un vehículo sin ninguna lectura válida no tiene
kilometraje, no cero: el sistema lo trata como dato ausente en todas partes.
