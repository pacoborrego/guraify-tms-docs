...
| `tms_odoo_app`, `MapPage.vue` y `ChatPage.vue` | Map · Chat (títulos de pantalla) | Mapa · Chat | Título en inglés en la pestaña Mapas (visto en D11) |
| `tms_odoo_app`, `SparkScan_CheckLoad.vue` | Parcels (título) | Bultos | Título en inglés en la pantalla de comprobar bultos (visto en D11) |
| `tms_odoo_app`, `ReasonModal.vue` | ELIJE UNA OPCION | ELIGE UNA OPCIÓN | Ortografía (visto en D11) |
