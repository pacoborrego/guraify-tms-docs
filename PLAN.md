...
| D6 | ⬜ | **Cap. 3 Arquitectura** | Sacar campos y métodos de la prosa (quedan en el aviso "Ruta en Odoo" o en anexo). Corregir las referencias a los caps. 6 y 8. Corregir 3.3: dice que el planificador fija el objetivo del optimizador (minimizar distancia, tiempo o ventanas); no existe tal opción, la calidad y las prioridades van fijas (visto en D5) |
